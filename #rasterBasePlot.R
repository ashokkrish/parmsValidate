...
#------------------------#
# # Set working directory to the root directory otherwise the below examples will not run
#
...
#
# createBasePlot(selectedCountry = "France", rasterAgg = 0, directOutput = T)
# createBasePlot(selectedCountry = "France", rasterAgg = 0, directOutput = F)
# 
# createBasePlot(selectedCountry = "Ireland", rasterAgg = 0, directOutput = T)
# createBasePlot(selectedCountry = "Ireland", rasterAgg = 0, directOutput = F)
 
# createBasePlot(selectedCountry = "Luxembourg", rasterAgg = 0, directOutput = T)
# createBasePlot(selectedCountry = "Luxembourg", rasterAgg = 0, directOutput = F)
